 ...
 */
public class AdminBannersServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if(idioma!=null) {
                if(!idioma.equalsIgnoreCase("0")){
                    if(!idioma.equalsIgnoreCase(txt.getIdioma())){
                        TextosTiendaDAO txtDAO = (TextosTiendaDAO) request.getServletContext().getAttribute("txtDAO");
                        txt = txtDAO.consultaTextosTienda(idioma);
                    }
                    switch(BannerServlet.TipoBanner.valueOf(tipo.toUpperCase())){
                        case HOME:
