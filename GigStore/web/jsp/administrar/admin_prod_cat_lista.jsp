<%-- 
    Document   : admin_prod_cat_lista
    Created on : 30/03/2013, 21:59:46
    ...
    <body>
            ...
            <div id="contenido_g">
                <div id="ruta">
                    <ul>
                        ...
                        <li><bean:message key="ruta.lista_cat" /></li>
                    </ul>
                </div>
                <h1><bean:message key="titulo.tabla_categorias" /></h1>  
                <div class="cuadro">
                    <p class="meta"><span class="izda"></span><span class="dcha"><bean:message key="titulo.tabla_categorias" /></span></p>
                    <div class="entrada">      
                        <p class="error">${error_borrar_cat}</p>                         
                        <form name="listadoCatForm" action="${pageContext.request.contextPath}/administrar/productos/categorias.do">
                            <input type="hidden" name="metodo" value="mostrar_listado">
                            ${listado_cats}
                        </form>
                    </div>
                    <p class="links"><a class="alta" href="${pageContext.request.contextPath}/administrar/productos/categorias/editar.do?metodo=alta_inicio"><bean:message key="enlace.alta_categoria" /></a></p>                    
                </div>
            </div>             
        </div>
        <ctrl:pie />
        ...
        <script type="text/javascript">
            ...
            function onInvokeExportAction(id) {
                ...
                location.href = '${pageContext.request.contextPath}/administrar/productos/categorias.do?metodo=mostrar_listado&' + parameterString;
            }
        </script>
    </body>
</html>
