<%-- 
    Document   : admin_ped_estado_lista
    Created on : 30/03/2013, 21:38:40
    ...
    <body>
            ...
            <div id="contenido_g">
                ...
                <div class="cuadro">
                    ...
                    <div class="entrada"> 
                        ...
                        <form name="listadoEstadosPedForm" action="${pageContext.request.contextPath}/administrar/pedidos/estados.do">
                            <input type="hidden" name="metodo" value="mostrar_listado">
                            ${listado_estados_ped}
                        </form>
                    </div>
                    <p class="links"><a class="alta" href="${pageContext.request.contextPath}/administrar/pedidos/estados/editar.do?metodo=alta_inicio"><bean:message key="enlace.alta_estado" /></a></p>
                </div>
            </div>             
        </div>
        <ctrl:pie />
        ...
        <script type="text/javascript">
            ...
            function onInvokeExportAction(id) {
                ...
                location.href = '${pageContext.request.contextPath}/administrar/pedidos/estados.do?metodo=mostrar_listado&' + parameterString;
            }
        </script>
    </body>
</html>
