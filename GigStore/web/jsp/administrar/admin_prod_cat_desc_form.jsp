<%-- 
    Document   : admin_prod_cat_desc_form
    Created on : 18/05/2012, 19:21:00
    Author     : Manel Márquez Bonilla
    Descripcion: Formulario editar descripción categorías
--%>
    ...
    <head>
        ...
        <title>
            <c:if test="${accion=='alta'}">
                <bean:message key="titulo.alta_categoria_desc" />
            </c:if>
            <c:if test="${accion=='editar'}">
                <bean:message key="titulo.modificar_categoria_desc" />
            </c:if>
        </title>
    </head>
    <body>
            ...
            <div id="contenido_g">
                <div id="ruta">
                    <ul>
                        ...
                        <li><a href="${pageContext.request.contextPath}/administrar/productos/categorias/detalle.do?metodo=mostrar_detalle&id=${id_cat}" ><bean:message key="ruta.detalle_cat" /></a> &gt </li>
                ...
                <div class="cuadro">
                    <p class="meta"><span class="izda"></span><span class="dcha"><bean:message key="titulo.modificar_categoria_desc" /></span></p>
                    <div class="entrada">
                        <div id="formulario">
                            <html:errors />
                            <html:form action="/administrar/productos/categorias/descripciones/alta" acceptCharset="ISO-8859-1" >
                                <div class="campos">
                                    ...
                                    <p class="etiqueta"><bean:message key="texto.mdcategorias" /></p>
                                ...
                                <div class="valores">
                                    ...
                                    <html:text property="mdCategorias" maxlength="255" />
                                </div>
                                <div id="txtdesc">
