<%-- 
    Document   : admin_opt_lista
    Created on : 28/05/2013, 21:04:04
    Author     : Manel Márquez Bonilla
    Descripcion: Listado de opciones
--%>
    ...
    <body>
            ...
            <div id="contenido_g">
                <div id="ruta">
                    <ul>
                        ...
                        <li><bean:message key="ruta.lista_opts" /></li>
                    </ul>
                </div>
                <h1><bean:message key="titulo.opciones" /></h1>  
                <div class="cuadro">
                    <p class="meta"><span class="izda"></span><span class="dcha"><bean:message key="titulo.tabla_opciones" /></span></p>
                    <div class="entrada">      
                        <p class="error">${error_borrar_opt}</p>                         
                        <form name="listadoOptForm" action="${pageContext.request.contextPath}/administrar/opciones.do">
                            <input type="hidden" name="metodo" value="mostrar_listado">
                            ${listado_opciones}
                        </form>
                    </div>
                    <p class="links"><a class="alta" href="${pageContext.request.contextPath}/administrar/opciones/editar.do?metodo=alta_inicio"><bean:message key="enlace.alta_opcion" /></a></p>                    
                </div>
            </div>             
        </div>
        <ctrl:pie />
        ...
        <script type="text/javascript">
            ...
            function onInvokeExportAction(id) {
                ...
                location.href = '${pageContext.request.contextPath}/administrar/opciones.do?metodo=mostrar_listado&' + parameterString;
            }
        </script>
    </body>
</html>
