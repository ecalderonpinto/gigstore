...
public class paypalfunctions  {
    ...
    public paypalfunctions() {//lhuynh - Actions to be Done on init of this class
        ...
        gv_APIUserName	= "polini_1349278418_biz_api1.gmail.com";
        gv_APIPassword	= "1349278446";
        gv_APISignature = "Ae.kvM8lsbD2jTvIkqfyhLmB7ghyAWJ7E911oJHJUx6aYJvrpftmgrix";
    ...
    public HashMap CallShortcutExpressCheckout(String paymentAmount, String returnURL, String cancelURL) throws Exception {
        try {
            ...
            */
            ...
            is stored in $nvpstr
            */
            String nvpstr = "&PAYMENTREQUEST_0_AMT=" + paymentAmount + "&PAYMENTREQUEST_0_PAYMENTACTION=" + paymentType + "&ReturnUrl=" + URLEncoder.encode(returnURL, "ISO-8859-1") + "&CANCELURL=" + URLEncoder.encode(cancelURL, "ISO-8859-1") + "&PAYMENTREQUEST_0_CURRENCYCODE=" + currencyCodeType;
            /*
    ...
    * Output: Returns a HashMap object containing the response from the server.
    *********************************************************************************/
    public HashMap CallMarkExpressCheckout(String paymentAmount, String returnURL, String cancelURL, String shipToName, String shipToStreet, String shipToStreet2, String shipToCity, String shipToState, String shipToCountryCode, String shipToZip, String phoneNum, String currencyCodeType, String paymentType, String itemATM, String shippingATM, String taxATM, ArrayList<PedidoLinea> carrito) throws Exception {
        /*
        '------------------------------------
        ' The currencyCodeType and paymentType 
        ' are set to the selections made on the Integration Assistant 
...
//        String paymentType = "Sale";
        ...
        */
        try {
            ...
            nvpstr=nvpstr.concat("&PAYMENTREQUEST_0_CURRENCYCODE=" + currencyCodeType + "&RETURNURL=" + URLEncoder.encode(returnURL, "ISO-8859-1") + "&CANCELURL=" + URLEncoder.encode(cancelURL, "ISO-8859-1"));
            ...
            for(PedidoLinea lp: carrito){
                nvpstr=nvpstr.concat("&L_PAYMENTREQUEST_0_NAME" + i + "=" + lp.getProducto().getNombre() + "&L_PAYMENTREQUEST_0_AMT" + i + "=" + df.format(lp.getPrecio()).replace(',', '.') + "&L_PAYMENTREQUEST_0_NUMBER" + i + "=" + lp.getProducto().getReferencia() + "&L_PAYMENTREQUEST_0_QTY" + i + "=" + lp.getCantidad());
                i++;
            }
            nvpstr=nvpstr.concat("&PAYMENTREQUEST_0_ITEMAMT=" + itemATM + "&PAYMENTREQUEST_0_SHIPPINGAMT=" + shippingATM );//+ "&PAYMENTREQUEST_0_TAXAMT=" + taxATM
    ...
    *********************************************************************************/
    public HashMap httpcall(String methodName, String nvpStr) throws Exception
    {
        ...
        deformatNVP(nvpStr);
        String encodedData = "METHOD=" + methodName + "&VERSION=" + gv_Version + "&PWD=" + gv_APIPassword + "&USER=" + gv_APIUserName + "&SIGNATURE=" + gv_APISignature + "&BUTTONSOURCE=" + gv_BNCode + "&" + nvpStr;
        ...
        try
        {
            ...
            if (rc != -1)
            {
                BufferedReader is = new BufferedReader(new InputStreamReader(in /*conn.getInputStream()*/));
                String _line = null;
    ...
    *********************************************************************************/
    public HashMap deformatNVP(String pPayload) throws Exception
    {
        ...
        while (stTok.hasMoreTokens())
        {
            ...
            {
                try {
                    String key = URLDecoder.decode(stInternalTokenizer.nextToken(), "ISO-8859-1");
                    String value = URLDecoder.decode(stInternalTokenizer.nextToken(), "ISO-8859-1");
