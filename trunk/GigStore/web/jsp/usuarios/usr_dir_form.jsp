            ...
            <div id="contenido">
                <div id="ruta">
                    <ul>
                        ...
                        <li><a href="${pageContext.request.contextPath}/usuario/gestion.do?metodo=mostrar_detalle" ><bean:message key="ruta.menu_user" /></a> &gt </li>
                        <li><bean:message key="ruta.editar_dir" /></li>
                    </ul>
                </div>
                <h1>
                    <c:if test="${accion=='alta'}">
                ...
                <div class="cuadro">
                    <p class="meta"><span class="izda"></span><span class="dcha"><bean:message key="ruta.editar_dir" /></span></p>
                    <div class="entrada">
                        <div id="formulario">
                            <html:errors />
                            <html:form action="/usuario/direcciones/alta" acceptCharset="ISO-8859-1" >
                                <div class="campos">
