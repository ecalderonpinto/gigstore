<%-- 
    Document   : admin_opt_valor_form
    Created on : 28/05/2013, 21:06:35
    Author     : Manel Márquez Bonilla
    Descripcion: Formulario editar valores
--%>
    ...
    <head>
        ...
        <title>
            <c:if test="${accion=='alta'}">
                <bean:message key="titulo.alta_valor" />
            </c:if>
            <c:if test="${accion=='editar'}">
                <bean:message key="titulo.modificar_valor" />
            </c:if>
        </title>
            ...
            <div id="contenido_g">
                <div id="ruta">
                    <ul>
                        ...
                        <li><a href="${pageContext.request.contextPath}/administrar/opciones/detalle.do?metodo=mostrar_detalle&id=${opt_id}" ><bean:message key="ruta.detalle_opt" /></a> &gt </li>
                        <li><bean:message key="ruta.editar_valor" /></li>
                    </ul>
                </div>
                <h1>
                    <c:if test="${accion=='alta'}">
                ...
                <div class="cuadro">
                    <p class="meta"><span class="izda"></span><span class="dcha"><bean:message key="titulo.modificar_valor" /></span></p>
                    <div class="entrada">
                        <div id="formulario">
                            <html:errors />
                            <html:form action="/administrar/opciones/valores/alta" acceptCharset="ISO-8859-1" >
                                <div class="campos">
                                    <p class="etiqueta"><bean:message key="texto.valor" /></p>
                                </div>
                                <div class="valores">
                                    <html:text property="valor" />
                                </div>
                                    
                                <div class="campos dli">
                                ...
                                <div class="valores dli">
                                    ...
                                    <input type="button" id="addopt" class="dli" name="addopt" value="<bean:message key="boton.add_trad" />" onclick="adOption.addOption('sel_list', 'optval');" /> &nbsp;
                                    <input type="button" id="del_opt" class="dli" name="del_opt" value="<bean:message key="boton.del_trad" />" onclick="adOption.delOption('sel_list', 'optval');" />
                                </div>
                                <div id="botones">
                                    <c:if test="${accion=='alta'}">
