<%-- 
    Document   : admin_txt_tienda_listado
    Created on : 28/03/2013, 20:54:47
    ...
    <body>
            ...
            <div id="contenido_g">
                <div id="ruta">
                    <ul>
                        ...
                        <li><bean:message key="ruta.admin_txt" /></li>
                    </ul>
                </div>
                <h1><bean:message key="titulo.textos_tienda" /></h1>
                <div class="cuadro">
                    <p class="meta"><span class="izda"></span><span class="dcha"><bean:message key="titulo.textos_tienda" /></span></p>
                    <div class="entrada">                            
                        <form name="listadoTextosTienda" action="${pageContext.request.contextPath}/administrar/tienda/textos.do">
                            <input type="hidden" name="metodo" value="mostrar_listado">
                            ${listado_textos_tienda}
                        </form>
                    </div>
                    <p class="links"><a class="editar" href="${pageContext.request.contextPath}/administrar/tienda/textos/editar.do?metodo=alta_inicio"><bean:message key="enlace.alta_txt" /></a></p>
                </div>
            </div>             
        </div>
        <ctrl:pie />
        ...
        <script type="text/javascript">
            ...
            function onInvokeExportAction(id) {
                ...
                location.href = '${pageContext.request.contextPath}/administrar/tienda/textos.do?metodo=mostrar_listado&' + parameterString;
            }
        </script>
    </body>
</html>
