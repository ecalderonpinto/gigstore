<%-- 
    Document   : admin_usr_estado_form
    Created on : 12/04/2012, 17:41:13
    Author     : Manel Márquez Bonilla
    Descripcion: Formulario alta/modificacion de estados de los usuarios
--%>
    ...
    <head>
        ...
        <title>
            <c:if test="${accion=='alta'}">
                <bean:message key="titulo.alta_estado_user" />
            </c:if>
            <c:if test="${accion=='editar'}">
                <bean:message key="titulo.modificar_estado_user" />
            </c:if>
        </title>
    </head>
    <body>
            ...
            <div id="contenido_g">
                <div id="ruta">
                    <ul>
                        ...
                        <li><a href="${pageContext.request.contextPath}/administrar/usuarios/estados.do?metodo=mostrar_listado" ><bean:message key="ruta.gestionar_estados" /></a> &gt </li>
                ...
                <div class="cuadro">
                    ...
                    <div class="entrada">
                        <div id="formulario">
                            <html:errors />
                            <html:form action="/administrar/usuarios/estados/alta" acceptCharset="ISO-8859-1" >
                                <div class="campos">
